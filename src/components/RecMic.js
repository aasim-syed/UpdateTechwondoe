    ...
    return (
      <div>
        ...
        {/* <Audio
          ...
          controls
          src = {
                  this.state.audioData ? this.state.audioData.url : null
          }  
        /> */}
        <MuiButton 
        style={{backgroundColor:'lightgreen',borderRadius:'12px',fontFamily:'Inter',padding:'7px',fontSize:'15px'}} id='record' onClick={this.start}>
        Start 🎙️🎤
        </MuiButton>
        <MuiButton 
